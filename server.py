...
class Magazine:
    def __init__(self, templates_dir: str= None, static_dir: str= None) -> None:
        self.templates_dir = Path( templates_dir ) if templates_dir else BASE_DIR / "web" / "templates"
        self.static_dir = Path( static_dir ) if static_dir else BASE_DIR / "web" / "static"
    ...
    def _load_base_templates(self) -> None:
        ...
        self._templates_cache['categories.html'] = self._read_template( 'categories.html' )
